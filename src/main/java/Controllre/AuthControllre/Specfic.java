...
public class Specfic {
    ...
    @PostMapping("/login/")
    public Map<String,Object> LoginAtro(@RequestParam("username") String user,@RequestParam("password") String password){
    ...
    public Map<String,Object> RegisterAtro(@RequestParam("username") String user,@RequestParam("email") String email,@RequestParam("password") String password){
